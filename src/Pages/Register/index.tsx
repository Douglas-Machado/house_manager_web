            ...
            <div className="bg-slate-800 border border-slate-600 rounded-md p-8 backdrop-filter backdrop-blur-lg bg-opacity-30 relative transition-all duration-200">
                ...
                <form action="">
                    ...
                    <div className="relative my-4">
                        <input
                            type="password"
                            className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""
                        />
                        <label
                            htmlFor=""
                    ...
                    <div>
                        <span className="m-4">Already Have an Account? <Link to={'/login'} className="text-blue-500">Login</Link></span>
                    </div>
                </form>
            </div>
        </div>
